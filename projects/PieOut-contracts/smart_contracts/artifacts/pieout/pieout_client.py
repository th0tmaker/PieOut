...
class ReadBoxGameStateArgs:
    ...
    @property
    def abi_method_signature(self) -> str:
        return "read_box_game_state(uint64)(uint64,bool,uint8,uint8,uint8,uint8,uint8,uint16,uint64,uint64,address,address,address,address)"
...
class PieoutClient:
    ...
    def decode_return_value(
        self,
        method: typing.Literal["read_box_game_state(uint64)(uint64,bool,uint8,uint8,uint8,uint8,uint8,uint16,uint64,uint64,address,address,address,address)"],
        return_value: algokit_utils.ABIReturn | None
...
class PieoutFactoryCreateParams:
    ...
    def read_box_game_state(
        ...
        *,
        ...
        """Creates a new instance using the read_box_game_state(uint64)(uint64,bool,uint8,uint8,uint8,uint8,uint8,uint16,uint64,uint64,address,address,address,address) ABI method"""
        params = params or algokit_utils.CommonAppCallCreateParams()
        return self.app_factory.params.create(
            algokit_utils.AppFactoryCreateMethodCallParams(
                **{
...
class PieoutComposer:
    ...
    def read_box_game_state(
        ...
        self._result_mappers.append(
            lambda v: self.client.decode_return_value(
                "read_box_game_state(uint64)(uint64,bool,uint8,uint8,uint8,uint8,uint8,uint16,uint64,uint64,address,address,address,address)", v
            )
        )
        return self
